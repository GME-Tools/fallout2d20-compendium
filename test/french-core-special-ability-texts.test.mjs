...
for(const pack of ["denizens"])test(`French ${pack} special-ability descriptions are complete and translated`,async()=>{
  const enDir=path.join("generated", "source-packs","en",`${pack}.db`),frDir=path.join("generated", "source-packs","fr",`${pack}.db`),enById=new Map();
