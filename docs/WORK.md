...
Continue page-by-page at printed/source p.143 with X-01 Power Armor: family description/slot rule, all 20 Mk II–VI Upgrade mods, the Winterized plating exclusion, and the unique EMP Shielding plating mod. Do not re-audit pp.1–142.
...
There are no unresolved anomalies or owner decisions in the completed p.1–142
boundary.
