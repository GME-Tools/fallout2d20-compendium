...
Continue page-by-page at printed/source p.146 with Robot Armor: the family rules and the Robot Armor Types table, continuing onto p.147 if required to close that table. Do not re-audit pp.1–145.
...
There are no unresolved anomalies or owner decisions in the completed p.1–145
boundary.
