...
- EN PDF physical pages 1–171, through printed/source page 169.
- FR PDF physical pages 1–172, through printed/source page 169.
...
Continue page-by-page at printed/source p.170, closing the remaining Chem descriptions and auditing Other Consumables, including the deferred Stimpak Diffuser conflict. Do not re-audit pp.1–169.
...
The completed p.1–165 boundary has one explicitly deferred internal-source ambiguity, not an owner decision: the EN p.165 Chem Items row for Stimpak Diffuser conflicts with the later EN p.170 Other Consumables row (and FR p.170) on category, weight, and cost. The stable document is left on its existing p.170-oriented category/cost until the p.170 audit resolves the full identity.
