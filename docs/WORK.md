...
- EN PDF physical pages 1–133, through printed/source page 131.
- FR PDF physical pages 1–134, through printed/source page 131.
- Completed editorial sections: front matter, Introduction, Chapter One (Core
  ...
  (source pp.84–131), including all weapon sections, Dog Armor, Ballistic Weave,
...
Continue page-by-page at printed/source p.132 with the Synth Armor and Vault-Tec Security Armor tables. Do not re-audit pp.1–131.
...
There are no unresolved anomalies or owner decisions in the completed p.1–131
boundary.
