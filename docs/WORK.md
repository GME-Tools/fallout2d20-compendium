...
Continue page-by-page at printed/source p.144 with Power Armor Mods: the shared System-mod rules and the first System-mod table rows. Continue onto p.145 only if needed to close the table cleanly. Do not re-audit pp.1–143.
...
There are no unresolved anomalies or owner decisions in the completed p.1–143
boundary.
