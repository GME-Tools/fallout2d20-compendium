...
- EN PDF physical pages 1–175, through printed/source page 173.
- FR PDF physical pages 1–176, through printed/source page 173.
- Completed editorial sections: front matter, Introduction, Chapters One–Three, and
  Chapter Four through source p.173, including weapons, apparel/armor, food and
...
Source p.141 is certified for T-51 Power Armor: the complete EN/FR family description, the three-slot Upgrade/Plating/System rule, and all 20 T-51b through T-51f Upgrade identities. All six T-51 armor pieces were corrected from two to three mod slots. Numeric-only Upgrade perk fields were normalized to Armorer 1 for T-51b, Armorer 2 for T-51c, Armorer 2 + Science! 1 for T-51d, Armorer 3 + Science! 1 for T-51e, and Armorer 3 + Science! 2 for T-51f, including embedded copies. The official FR family text replaces the earlier paraphrase. Generic System/Plating acceptance was initially resolved from pp.144–145 as an explicit dependency; those shared mod mechanics are now fully certified through p.145. Errata V6 contains no p.141 correction.
...
Continue page-by-page at printed/source p.173, continuing Books and Magazines with the Astoundingly Awesome Tales issue table and the independently ordered FR material. Do not re-audit pp.1–172.
...
The p.165 Stimpak Diffuser internal-source conflict is now resolved at p.170 without hiding the discrepancy: EN p.165 prints a Chem row at <1 lb and 200 caps, while the dedicated EN p.170 Other Consumables table, adjacent detailed identity, and official FR p.170 table agree on the Other Consumable identity at 1 lb / 0.5 kg and 100 caps. The reusable document follows p.170; the p.165 row remains a verified reference documenting the conflicting print.
...
The p.149 regression verifies the three opening Consumables/Food rule blocks, all 29 bilingual food identities reached from the independently ordered EN/FR p.149 tables plus their targeted later-language counterparts, exact HP/irradiation/weight/cost/rarity/effect fields, explicit non-alcoholic metadata and source provenance, the official French secondary-effect wording, and the recorded Fancy Lads FR weight discrepancy without advancing pp.150–151 page coverage. The p.150 regression then verifies the complete 30-row EN and 34-row FR source-page sets as 50 stable bilingual identities, all 35 newly reached identities with exact mechanics/provenance/weights/effects, and the deliberate FR Food Paste duration adaptation from the printed current-scene wording to the EN-authoritative next-scene mechanic. The p.151 regression closes the 75-identity Food Items table, verifies the complete EN/FR page sets and the 11 final identities, and locks the Potted Meat 1-CD table-column versus 2-CD consumption override. The p.152 regression begins the descriptive Food audit: all eight EN p.152 descriptions and all seven independently ordered FR p.152 descriptions are source-exact in both locales after targeted counterpart lookup, recipe sections are retained on the four affected prepared-food identities, and the errata p.152 entry is explicitly scoped to Winter of Atom rather than Core. The p.153 regression certifies the 11 EN and 11 FR description headings on that source page as 19 stable bilingual identities, restores the official French prose on the 17 descriptions not already closed by p.152, preserves all nine affected cooking-recipe sections, and records exact bilingual description coordinates without advancing later page coverage. The p.154 regression certifies the 12 EN and 10 FR description entries on that source page as 21 stable bilingual identities, restores the official French wording for the 14 descriptions first reached by this lot, preserves all affected recipe sections, and records exact bilingual description provenance through p.154. The p.155 regression certifies the nine EN and nine FR description entries on that source page as 17 stable bilingual identities, restores the remaining official French wording for the newly reached Mirelurk/Mole Rat and egg/pastry descriptions, preserves the seven affected cooking-recipe sections, and records exact bilingual description provenance through p.155. The p.156 regression certifies the 10 EN and 12 FR description headings on that source page as 21 stable bilingual identities, restores the official French prose for the nine descriptions first reached by this lot, preserves all affected cooking-recipe sections, records targeted counterpart coordinates through EN p.159 and FR p.160 without advancing those later page boundaries, and explicitly scopes Errata V6’s numbered p.156 entry to Royal Flush rather than the Core Rulebook. The p.157 regression certifies 12 EN descriptions plus 12 new FR headings and the carried-over Yao Guai Roast continuation as 23 stable bilingual identities, restores the official French prose for the eight descriptions first closed by this lot, preserves all affected cooking-recipe sections, records targeted counterpart coordinates through EN p.159 and FR p.159 without advancing later page boundaries, and explicitly scopes Errata V6’s numbered p.157 entry to Settlers Guide Book rather than the Core Rulebook. The p.158 regression closes nine EN and eight FR Food-description identities (17 distinct identities total); every one had already been made source-exact by earlier targeted counterpart reads, so this lot requires no locale prose change. It verifies the complete page sets, retained recipe sections, and that Errata V6 contains no numbered p.158 correction. The p.159 regression closes five EN and five FR Food-description headings as nine stable bilingual identities. Yao Guai Meat is the sole newly closed description; its official French prose spans source pp.159–160 and replaces the legacy paraphrase, while the targeted p.160 continuation read does not advance the p.160 page boundary. The page has no numbered p.159 Errata V6 entry. The p.160 regression opens Beverages: it inventories the shared consumption, duration and Alcoholic/addiction rules as explicit out-of-scope mechanics, certifies the 18 EN and 13 FR table rows as 19 stable bilingual beverage identities after targeted p.161 counterpart reads, and records exact bilingual coordinates without advancing p.161. The audit normalizes every printed <1 lb / <0.5 kg row to the project’s zero sentinel, reclassifies Dirty Wastelander from the legacy food type to beverage, restores the official French table-effect wording, and preserves the Irradiated Blood distinction between its 1-CD irradiated column and its 2-CD consumption override. FR p.160’s carried Yao Guai Meat and Potted Meat prose remains covered by the earlier description regressions. Errata V6 has no Core p.160 table correction; the 8 April 2021 p.216–217 beverage erratum applies only to later crafting listings. Source p.161 closes the Beverage Items table with Vodka, Whiskey/Whisky and Wine/Vin as the three newly reached identities, while targeted p.161 counterparts from the previous lot become page-certified without duplication. The Maximum HP procedure is explicitly inventoried as out of compendium scope. Detailed beverage prose begins here: seven EN and five FR headings resolve to ten bilingual identities after targeted counterpart reads on EN pp.162–163 and FR pp.162–163, without advancing those later boundaries. Official French prose replaces the remaining paraphrases for Beer, Blood Pack, Bourbon, Brahmin Milk, Dirty Wastelander, Dirty Water, Glowing Blood Pack, Refreshing Beverage, Moonshine and Purified Water; recipe sections remain intact. The EN Bourbon extraction is corrected to the printed “Pre-War”. Errata V6 has no Core p.161 correction; its p.216–217 beverage entry remains scoped to later crafting listings. Source p.162 continues the beverage descriptions and explicitly inventories the Nuka-Cola Addiction sidebar as non-document rules guidance: it may affect NPCs, but player characters do not risk that addiction. EN p.162 and FR p.162 jointly cover eleven previously established beverage identities; targeted counterpart reads on EN p.163 and FR p.163 close Irradiated Blood, Tarberry Juice, Tato Juice and Nuka Cola without advancing p.163. Official French prose replaces the remaining paraphrases for Irradiated Blood, Melon Juice, Mutfruit Juice, Nuka Cherry, Nuka Cola, Tarberry Juice and Tato Juice, with cooking-recipe sections preserved. Errata V6 has no Core p.162 correction; the p.216–217 beverage erratum remains limited to later crafting listings. Source p.163 closes the beverage-description sequence in both languages. Nine EN and nine FR headings cover thirteen established identities; five descriptions reach their first fully certified bilingual closure here: Nuka-Cola Quantum/Nuka Cola Quantum, Rum/Rhum, Vodka, Whiskey/Whisky and Wine/Vin. Their French overlays are replaced with the official prose, while all earlier targeted p.163 counterpart reads become ordinary page-certified coverage without duplicate inventory entries. Errata V6 has no Core p.163 correction; the p.216–217 beverage erratum remains limited to later crafting listings. Source p.164 opens Chems/Drogues. The shared administration, duration/stacking, addiction and duration-extension procedures are inventoried explicitly as out-of-scope rules. Eight EN and nine FR table rows resolve to ten stable bilingual chem identities after targeted p.165 counterpart reads for Berry Mentats/Mentats fruits rouges, Healing Salve/Baume de soin and Skeeto Spit/Bave de scrito. The audit fixes a legacy cross-type defect on all ten identities: chems were incorrectly flagged as both alcoholic and irradiated; both flags are now false. Printed <1 lb / <0.5 kg weights use the project zero sentinel, and EN/FR table effects are normalized to the exact source wording. Errata V6’s numbered p.164–165 correction belongs to Wasteland Wanderer, not the Core Rulebook. Source p.165 closes the Chem Items table. Twenty-two newly reached chem identities are certified in both languages, while the three targeted p.165 counterparts from the prior lot (Berry Mentats, Healing Salve and Skeeto Spit) become ordinary page-certified coverage. The same legacy cross-type defect found on p.164 continues across these twenty-two chems and is corrected: `alcoholic` and `irradiated` are false, printed <1 lb / <0.5 kg weights use the zero sentinel, and localized effects are normalized to the source tables. X-Cell is corrected from an erroneous Instant duration to Lasting. Stimpak Diffuser is deliberately not rewritten from the p.165 row: EN p.165 lists it among Chems at <1 lb and 200 caps, while EN p.170 and FR p.170 list it under Other Consumables at 1 lb / 0.5 kg and 100 caps. Errata V6 does not resolve that conflict, so the p.165 reference is catalogued as ambiguous and deferred to the p.170 detailed audit. Source p.166 begins the detailed chem descriptions. Eight EN and nine FR headings cover ten established identities after targeted counterpart reads: Healing Salve is read on EN p.167, Berry Mentats on FR p.168, and Skeeto Spit on EN p.169; these reads do not advance the later certified boundaries. The remaining French paraphrases for Addictol, Antibiotiques, Baume de soin, Bave de scrito, Buffjet, Buffout, Bufftats, Calmex, Daddy-O and Mentats fruits rouges are replaced with the official localization, with existing crafting recipe sections preserved. Daddy-O’s French addiction clause continues onto p.167 and is certified as one description. Errata V6 contains no Core p.166 correction. Source p.167 continues the chem descriptions and inventories the Ghouls and Chems / Les goules et les drogues sidebar as shared rules guidance rather than a standalone document. Day Tripper/Daytripper, Fury/Fureur and Jet are closed directly on p.167 in both languages; Grape Mentats/Mentats raisin, Jet Fuel, Med-X and Mentats use targeted p.168 counterpart reads without advancing that later boundary. Healing Salve’s EN p.167 description and Daddy-O’s FR p.167 continuation become ordinary page-certified coverage from the previous lot. Official French prose replaces the remaining paraphrases for Daytripper, Fureur, Jet, Jet Fuel, Med-X, Mentats and Mentats raisin, with recipe sections preserved. Errata V6 contains no Core p.167 correction. Source p.168 continues the chem descriptions. Six EN identities and eight FR identities form a ten-identity bilingual page union after carrying forward the independently ordered descriptions already targeted from pp.166–167. Orange Mentats/Mentats orange, Overdrive, Psycho, Psychobuff and Psycho Jet are newly closed here; Psychobuff’s EN counterpart is on p.169 and Psycho Jet spans FR pp.168–169, neither targeted read advancing p.169. The official French prose replaces the remaining paraphrases for those five identities, and every affected crafting-recipe section is preserved. Existing p.166/p.167 description Errata notes are retained and augmented rather than overwritten. Errata V6’s numbered p.168 entry belongs to Settlers Guide Book (X6-88), not the Core Rulebook, and there is no numbered p.169 entry for the targeted counterparts. Source p.169 continues the chem descriptions and inventories the First Aid / Porter secours sidebar as out-of-scope shared procedure: Healing Salve, RadAway and Stimpaks may augment a First Aid action, but only one chem can be applied that way per action. Seven EN and five FR description identities form a seven-identity union. Psychotats, Rad-X, RadAway and Stimpak receive source-exact official French prose; Stimpak’s EN description continues onto p.170, which is read only as a targeted counterpart. The earlier Skeeto Spit provenance is corrected from an erroneous physical-page-style EN p.171 coordinate to its actual source p.169, while preserving the p.166 FR coordinate and prior Errata note. Existing p.168 certifications for Psycho Jet and Psychobuff become ordinary p.169 page coverage. Errata V6 contains no numbered p.169 or p.170 entry. Source p.170 closes the remaining Chem descriptions for Super Stimpak, Ultra Jet and X-Cell, while the Stimpak EN continuation read at p.169 becomes ordinary page-certified coverage. It then opens Other Consumables / Autres consommables and certifies Robot Repair Kit / Kit de réparation de robot, Stealth Boy and Stimpak Diffuser / Diffuseur à Stimpak as three stable bilingual identities. The legacy `alcoholic`/`irradiated` flags on all three Other Consumables are corrected to false, Stimpak Diffuser’s legacy string addiction flag is normalized to boolean false, and its EN/FR weights are restored to 1 lb / 0.5 kg. The p.165 Stimpak Diffuser conflict is resolved source-driven in favor of the dedicated p.170 Other Consumables identity (cost 100), with the conflicting p.165 Chem row retained as a verified reference. Official French prose is restored for Super Stimpak, Ultra Jet, X-Cell, Stimpak Diffuser and the p.170–171 Robot Repair Kit description; targeted p.171 counterpart reads do not advance the p.171 boundary. Stealth Boy’s detailed prose remains deliberately deferred to p.171. Errata V6 contains no numbered p.170 entry. Source p.171 closes the detailed Other Consumables descriptions. EN contains Robot Repair Kit, Stealth Boy and Stimpak Diffuser; FR contains the Robot Repair Kit continuation and Stealth Boy, while the FR Stimpak Diffuser description was already closed on p.170. Stealth Boy’s legacy French paraphrase is replaced with the official source prose; the p.170 targeted Robot Repair Kit and Stimpak Diffuser counterpart reads become ordinary p.171 page-certified coverage, and the Robot Repair Kit recipe remains intact. Errata V6 has two numbered p.171 entries, but they belong to Winter of Atom (Mister Gutsy Patriot) and Wasteland Wanderer (Caps table), not the Core Rulebook. Source p.172 opens Books and Magazines. The shared discovery/statistics/temporary-perk rules are inventoried explicitly, and the EN Random Publication d20 table is certified as the mechanical authority. Its official FR counterpart is printed on p.173 with a substantially different d20 ordering; the FR Foundry table deliberately retains the EN canonical ranges while localizing labels and links, and the discrepancy is recorded rather than hidden. ¡La Fantoma!/Fantômes en tous genres and Duck and Cover!/À couvert ! are certified as paired publication Items plus permanent learned-Perk documents using targeted p.173/p.174 counterparts. FR p.172 also reaches Guns and Bullets: its ten issue Items, ten linked learned-Perk documents, and d20 issue RollTable are resolved against EN p.175 without advancing that later boundary. Legacy French paraphrases are replaced by the official family prose and exact issue effects; learned Guns and Bullets perk documents now explicitly retain the source once-per-scene limit. Astoundingly Awesome Tales family rules are inventoried here, while its issue table remains correctly deferred to EN source p.173. Errata V6 contains no Core p.172/p.173/p.175 correction; the numbered p.174 entry belongs to Winter of Atom.
