...
- Active work: exhaustive Core Rulebook certification; source pages 1–174 are the current certified boundary and p.175 is the next lot; the Stimpak Diffuser p.165/p.170 source conflict remains resolved and documented, and the p.172 EN/FR Random Publication ordering divergence is explicitly recorded with EN mechanics authoritative.
